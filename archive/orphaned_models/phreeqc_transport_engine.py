...
class PhreeqcTransportEngine:
    ...
    def generate_transport_input(self, 
        ...
        # Each shift = 1 pore volume through entire column = 1 bed volume (for IX columns)
        input_str.append("    10 bed_vol = STEP_NO")
        input_str.append("    20 PUNCH bed_vol")
        input_str.append("    30 PUNCH TOT(\"Ca\") * 40080  # Convert mol/kgw to mg/L")
        input_str.append("    40 PUNCH TOT(\"Mg\") * 24305")
        input_str.append("    50 PUNCH TOT(\"Na\") * 22990")
        input_str.append("    60 PUNCH TOT(\"Fe\") * 55845")
        input_str.append("    70 PUNCH TOT(\"Mn\") * 54938")
        input_str.append("")
